        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                className="w-full p-2.5 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-pink-500 transition"
                value={formData.name}
                onChange={(e) =>
          ...
          {isEditing && (
            <button
              ...
              className="w-full text-slate-400 text-sm font-medium hover:text-pink-600 transition"
            >
              Batalkan Edit
            </button>
          )}
        ...
        <div className="lg:col-span-2">
          ...
          <div className="relative w-full md:w-64 mb-6">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-pink-500 bg-white transition"
              value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredRooms.map((room) => (
              <div
                key={room.id}
                className="bg-white p-6 rounded-[28px] border border-slate-200 shadow-sm hover:shadow-md transition-all group"
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-bold text-slate-800 text-lg group-hover:text-pink-600 transition">
                      {room.name}
                    </h4>
                  ...
                  <button
                    ...
                    className="text-xs bg-pink-50 px-4 py-2 rounded-xl font-bold text-pink-600 hover:bg-pink-600 hover:text-white transition shadow-sm"
                  >
                    Detail
                  </button>
                </div>
